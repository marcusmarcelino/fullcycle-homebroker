...
func NewTransaction(sellingOrder *Order, buyingOrder *Order, shares int, price float64) *Transaction {
	// := trata-se de uma forma de declaração de variável e atribuição de valor
	// só preciso fazer isso uma vez, a partir daqui posso usar essa variável normalmente como uso uma javascript
